...
public class RandomTierListFactory {
    ...
    public static RandomTierListView create(ViewManagerModel viewManagerModel, RandomTierListViewModel randomTierListViewModel, GenerateTierListDataAccessInterface fileUserDataAccessObject, RandomTierListDataAccessInterface chatGPTDataAccessObject, TierListViewModel tierListViewModel) {
    ...
    private static RandomTierListController createRandomUseCase(ViewManagerModel viewManagerModel, RandomTierListViewModel randomTierListViewModel, GenerateTierListDataAccessInterface dataAccessObject, RandomTierListDataAccessInterface chatGPTDataAccessObject, TierListViewModel tierListViewModel) {
