...
Users can create an account and include whatever information about themselves they want to. Upon having completed at least one tournament, the app will start suggesting people that the algorithm thinks the user would be compatible with, and includes a score based off the similarity of their opinions.
